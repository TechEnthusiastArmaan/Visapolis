...
//  if (!settings) {
//     // You can return a simplified header or just null while it loads.
//     // Returning null is the simplest way to prevent the crash.
//     return null; 
//   }
  return (
    <>
...
<div className="row align-center">
  ...
  <div className="col-lg-6 info">
    <div className="address-info">
      <ul className="item-flex">
        <li><FontAwesomeIcon icon={faMapMarkerAlt} className="me-2" /> {settings.address || 'Your Address, City'}</li>
        <li><FontAwesomeIcon icon={faEnvelopeOpenText} className="me-2" /> {settings.email || 'info@example.com'}</li>
      </ul>
    </div>
  </div>
  ...
  <div className="col-lg-6">
              <div className="top-bar-right-group">
                <div className="call">
                  <a href={`tel:${settings.phoneNumber}`} className="call-icon-link">
                      <FontAwesomeIcon icon={faPhoneAlt} />
                  </a>
                  <div className="info">
                      <p>Need to discuss?</p>
                      <h5><a href={`tel:${settings.phoneNumber}`}>{settings.phoneNumber || '+1 234 567 890'}</a></h5>
                  </div>
                </div>
            ...
            <div className={`collapse navbar-collapse ${isMenuOpen ? 'show' : ''}`} id="navbar-menu">
              <ul className="nav navbar-nav navbar-right" data-in="fadeInDown" data-out="fadeOutUp">
                ...
                <li className="dropdown">
                  <a className="dropdown-toggle" data-toggle="dropdown" href="#">Visit <FontAwesomeIcon icon={faAngleDown} /></a>
